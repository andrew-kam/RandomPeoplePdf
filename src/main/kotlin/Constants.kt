...
val streetNames = listOf(
    ...
    "Набережная", "Комсомольская", "Зеленая", "Северная", "Коммунистическая",
    "Горького", "Молодежная", "Сосновая", "Октябрьская", "Заречная",
    "Мичурина", "Парковая", "Октябрьская", "Железнодорожная", "Лесная",
    ...
    "Социалистическая", "Спортивная", "Жукова", "Красноармейская", "Орджоникидзе",
    "Ново-Садовая", "Ленинградская"
)
